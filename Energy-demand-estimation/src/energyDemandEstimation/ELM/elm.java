...
public class elm {
	 ...
	 *            - Type of activation function: 'sig' for Sigmoidal function 'sin'
	 *            for Sine function 'hardlim' for Hardlim function 'tribas' for
	 *            Triangular basis function 'radbas' for Radial basis function (for
	...
	private void train() throws NotConvergedException {
		...
		// DenseMatrix pinvHt = invers.getMPInverse(0.000001); //fast method, PLEASE
		// CITE in your paper properly:
